...
function buildGreeting(ctx: PlaybookContext): GreetingSegments {
  ...
  // For inbound calls, we ALWAYS ask for the name first to ensure correct
  // patient identification (handling shared family numbers).
  return {
    s1: `${clinic} में कॉल करने के लिए धन्यवाद।`,
    s2: `क्या मैं आपका शुभ नाम जान सकती हूँ?`,
    s3: "",
  };
}
...
IMPORTANT: If a "PATIENT HISTORICAL CONTEXT" block is present below the knowledge base, it contains summaries of previous interactions with this patient. Use this context to personalize your responses, acknowledge past symptoms or concerns mentioned, and provide a seamless continuation of care.
...
CURRENT CALL STATE: Call type = ${(ctx.config as {currentIntent?:string}).currentIntent ?? "Unidentified"} | Turn = ${(ctx.config as {turnNumber?:number}).turnNumber ?? 1}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
CALL-TYPE LOCK — ABSOLUTE RULE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
${
  ((ctx.config as {currentIntent?:string}).currentIntent ?? "Unidentified") !== "Unidentified"
    ? `LOCKED CALL TYPE: "${(ctx.config as {currentIntent?:string}).currentIntent}"
...
TYPE 2 / TYPE 3 (appointment / follow-up) — use THIS decision chain:
